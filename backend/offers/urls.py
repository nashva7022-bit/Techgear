...
urlpatterns = [
    ...
    path(
        "product/<int:pk>/toggle/",
        views.toggle_product_offer,
        name="toggle_product_offer",
    ),
    path(
        "category/<int:pk>/toggle/",
        views.toggle_category_offer,
        name="toggle_category_offer",
    ),
    path(
    ...
    path(
        "category/<int:pk>/edit/", views.category_offer_edit, name="category_offer_edit"
    ),
]
