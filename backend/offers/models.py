    ...
    def clean(self):
        ...
        if self.product and self.start_date and self.end_date:
            ...
            for offer in overlapping:
                ...
                if not (self.end_date < offer.start_date or self.start_date > offer.end_date):
                    errors['start_date'] = f'Offer dates overlap with existing offer from {offer.start_date} to {offer.end_date}.'
                    break
