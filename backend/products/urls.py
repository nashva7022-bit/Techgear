...
urlpatterns = [
    ...
    path('products/toggle-customization/<int:pk>/', views.product_toggle_customization, name='admin_product_toggle_customization'),

    # ── Variants ──
    path('variants/',                       views.variant_list,    name='admin_variant_list'),
    path('variants/delete/<int:pk>/',       views.variant_delete,  name='admin_variant_delete'),
