    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping_address_line_2', models.CharField(blank=True, default='', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variant_sku', models.CharField(blank=True, default='', max_length=50)),
                ...
                ('subtotal', models.DecimalField(decimal_places=2, max_digits=10)),
                ('custom_text', models.CharField(blank=True, default='', max_length=100)),
                ('custom_image', models.ImageField(blank=True, null=True, upload_to='order_customizations/')),
